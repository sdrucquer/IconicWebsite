...
type EdgingServicePageProps = {
  service: Service;
};

const includedItems = [
  "Clean bed borders cut and redefined",
  "Sharper separation between lawn and beds",
  "Walkway and driveway edges cleaned up",
  "Edging debris cleared from visible areas",
  "A finished look before or after mulch"
];
...
const processSteps = [
  {
    eyebrow: "01",
    title: "Send the edge details",
    body: "Send photos or a quick note about the beds, walks, or driveway edges."
  },
  {
    eyebrow: "02",
    title: "Get a clear edging scope",
    body: "We confirm the areas, length, cleanup, and whether mulch is being added."
  },
  {
    eyebrow: "03",
    title: "Come home to cleaner lines",
    body: "The crew cuts the edges, clears debris, and leaves the property tidy."
  }
];
...
const faqItems = [
  {
    ...
    answer:
      "Yes. Edging is commonly included with bed cleanup and spring cleanup, and it can also be paired with mulching."
  },
  {
    question: "Can edging be booked by itself?",
    answer:
      "Yes. Standalone edging is available when the property mainly needs sharper bed, walkway, or driveway lines."
  },
  {
    question: "Why does edging make such a difference?",
    answer:
      "Clean edges create visual separation between beds, lawn, and hardscaping. It is one of the fastest ways to make a property look finished."
  },
  {
    question: "Should edging happen before mulch?",
    answer:
      "Usually yes. Cutting the edge first gives fresh mulch a cleaner border and a more intentional finished look."
  }
];
...
export function EdgingServicePage({ service }: EdgingServicePageProps) {
      ...
      <main className="bg-brand-cream pb-[86px] lg:pb-0">
        <section className="relative overflow-hidden bg-brand-ink text-white">
          <div className="relative min-h-[calc(100svh-78px)] lg:min-h-[calc(100vh-82px)]">
            <Image
              src="/photos/home/after.jpg"
              alt="Finished landscaping with clean edged beds"
              fill
              sizes="100vw"
            ...
            <div className="section-shell relative flex min-h-[calc(100svh-78px)] flex-col items-center justify-center py-16 text-center lg:min-h-[calc(100vh-82px)] lg:py-20">
              <div className="mx-auto max-w-5xl">
                ...
                <div className="mx-auto mt-9 flex w-full max-w-sm flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:items-center sm:justify-center">
                  <Button
                    href="/contact#quote"
                    ariaLabel="Get a free edging quote"
                    ...
                    trackEventParams={{ source: "edging_hero" }}
                  >
                    Get a Free Quote
                  </Button>
                  <a
                    ...
                    data-track-params='{"source":"edging_hero"}'
                  >
                    Call {PHONE_DISPLAY}
                  </a>
                </div>
          ...
          <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start lg:gap-16">
            ...
            <div>
              ...
              <p className="mt-5 inline-flex rounded-full bg-brand-bone px-4 py-2 text-sm font-semibold text-brand-forest">
                Mulch and bed cleanup available if needed.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid gap-3 lg:grid-cols-[1.35fr_0.65fr]">
              <figure className="group">
                <div className="relative aspect-[16/10] overflow-hidden rounded">
                  <Image
                    src="/photos/home/after.jpg"
                    alt="Finished edged bed result"
                    fill
                    sizes="(min-width: 1024px) 65vw, 100vw"
                    className="object-cover object-bottom transition-transform duration-700 group-hover:scale-[1.015]"
                  />
                </div>
                <figcaption className="meta mt-3 text-brand-ink/55">Finished edge result</figcaption>
              </figure>
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
                      src="/photos/services/edging/during.jpg"
                      alt="Edging in progress"
                      fill
                      sizes="(min-width: 1024px) 32vw, 50vw"
                      className="object-cover object-bottom"
                    />
                  </div>
                  <figcaption className="meta mt-3 text-brand-ink/55">Edging in progress</figcaption>
                </figure>
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
          ...
          <div className="grid gap-8 rounded bg-brand-bone px-5 py-7 md:px-8 md:py-9 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            <div>
              ...
              <a
                ...
                data-track-params='{"source":"edging_process"}'
              >
          ...
          <div className="section-shell">
            <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-16">
              <div>
                ...
                <h2 className="mt-4 h-section max-w-xl">Edging across Chester and Montgomery Counties.</h2>
                <p className="lede mt-5 text-brand-ink/70">
                  Based in Pottstown and active in nearby neighborhoods where crisp edges make beds feel finished.
                </p>
              </div>
        ...
        <section className="relative overflow-hidden bg-brand-forest text-brand-cream">
          <Image
            src="/photos/home/after.jpg"
            alt="Finished edged beds after service"
            fill
            sizes="100vw"
            className="object-cover"
          />
          ...
          <div className="section-shell relative band-feature text-center">
            ...
            <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
              <Button
                href="/contact#quote"
                ariaLabel="Request an edging quote"
                variant="secondary"
                className="px-9 py-4 text-base"
                trackEventName="cta_quote_click"
                trackEventParams={{ source: "edging_bottom" }}
              >
                Get a Free Quote
              </Button>
              <a
                ...
                data-track-event="click_to_text"
                data-track-params='{"source":"edging_bottom"}'
              >
                Text {PHONE_DISPLAY}
              </a>
            </div>
