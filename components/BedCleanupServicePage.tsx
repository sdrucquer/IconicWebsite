...
type BedCleanupServicePageProps = {
  service: Service;
};

const includedItems = [
  "Weeds and unwanted growth removed",
  "Beds cleaned and redefined",
  "Dead growth and debris cleared",
  "Clean edging along bed borders",
  "Walkways and visible edges tidied"
];
...
const processSteps = [
  {
    ...
    body: "Send photos or a quick note about the beds that need attention."
  },
  {
    eyebrow: "02",
    title: "Get a clear cleanup scope",
    body: "We confirm weeding, debris removal, edging, mulch, and haul-away."
  },
  {
    eyebrow: "03",
    title: "Come home to cleaner beds",
    body: "The crew resets the beds and leaves the surrounding areas tidy."
  }
];
...
const faqItems = [
  {
    ...
    answer:
      "Usually no. If we can access the beds and the scope is clear, we can complete the work and send updates."
  },
  {
    question: "How long does bed cleanup take?",
    answer:
      "Most residential bed cleanup jobs take 1-4 hours. Larger or heavily overgrown properties take longer, and we quote the scope upfront."
  },
  {
    question: "Should I mulch after bed cleanup?",
    answer:
      "Yes, if the beds are ready for a finished look. Cleanup plus mulch helps the result look cleaner and last longer."
  },
  {
...
export function BedCleanupServicePage({ service }: BedCleanupServicePageProps) {
  ...
  return (
    <>
      <SchemaMarkup
        type="service"
        payload={{
          name: "Bed Cleanup in Pottstown, PA",
      ...
      <main className="bg-brand-cream pb-[86px] lg:pb-0">
        <section className="relative overflow-hidden bg-brand-ink text-white">
          <div className="relative min-h-[calc(100svh-78px)] lg:min-h-[calc(100vh-82px)]">
            <Image
              src="/photos/home/bed-cleanup.jpg"
              alt="Finished bed cleanup by Iconic Landscaping"
              fill
              sizes="100vw"
            ...
            <div className="section-shell relative flex min-h-[calc(100svh-78px)] flex-col items-center justify-center py-16 text-center lg:min-h-[calc(100vh-82px)] lg:py-20">
              <div className="mx-auto max-w-5xl">
                ...
                <div className="mx-auto mt-9 flex w-full max-w-sm flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:items-center sm:justify-center">
                  <Button
                    href="/contact#quote"
                    ariaLabel="Get a free bed cleanup quote"
                    ...
                    trackEventParams={{ source: "bed_cleanup_hero" }}
                  >
                    Get a Free Quote
                  </Button>
                  <a
                    ...
                    data-track-params='{"source":"bed_cleanup_hero"}'
                  >
                    Call {PHONE_DISPLAY}
                  </a>
                </div>
              ...
              <figure className="group">
                <div className="relative aspect-[16/10] overflow-hidden rounded">
                  <Image
                    ...
                    alt="Finished bed cleanup result"
                    fill
                    sizes="(min-width: 1024px) 65vw, 100vw"
                    className="object-cover object-bottom transition-transform duration-700 group-hover:scale-[1.015]"
                  />
                </div>
                <figcaption className="meta mt-3 text-brand-ink/55">Finished bed cleanup result</figcaption>
              </figure>
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
                      src="/photos/home/bed-cleanup.jpg"
                      alt="Clean bed cleanup detail"
                      fill
                      sizes="(min-width: 1024px) 32vw, 50vw"
                      className="object-cover object-bottom"
                    />
                  </div>
                  <figcaption className="meta mt-3 text-brand-ink/55">Clean bed detail</figcaption>
                </figure>
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
          ...
          <div className="grid gap-8 rounded bg-brand-bone px-5 py-7 md:px-8 md:py-9 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            <div>
              ...
              <a
                ...
                data-track-params='{"source":"bed_cleanup_process"}'
              >
          ...
          <div className="section-shell">
            <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-16">
              <div>
                ...
                <h2 className="mt-4 h-section max-w-xl">Bed cleanup across Chester and Montgomery Counties.</h2>
                <p className="lede mt-5 text-brand-ink/70">
                  Based in Pottstown and active in nearby neighborhoods where clean beds and sharp edges make the property.
                </p>
              </div>
              <div className="grid border-y hairline md:grid-cols-2">
                {featuredAreas.map((area) => (
                  <Link
                    key={area.slug}
                    href={`/areas/${area.slug}/bed-cleanup`}
        ...
        <section className="relative overflow-hidden bg-brand-forest text-brand-cream">
          <Image
            ...
            alt="Finished bed cleanup after service"
            fill
            sizes="100vw"
            className="object-cover"
          />
          ...
          <div className="section-shell relative band-feature text-center">
            ...
            <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
              <Button
                href="/contact#quote"
                ariaLabel="Request a bed cleanup quote"
                variant="secondary"
                className="px-9 py-4 text-base"
                trackEventName="cta_quote_click"
                trackEventParams={{ source: "bed_cleanup_bottom" }}
              >
                Get a Free Quote
              </Button>
              <a
                ...
                data-track-event="click_to_text"
                data-track-params='{"source":"bed_cleanup_bottom"}'
              >
                Text {PHONE_DISPLAY}
              </a>
            </div>
