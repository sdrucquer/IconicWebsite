...
import { ArrowRight, Check, Clock3, MapPin, Quote, ShieldCheck, Star } from "lucide-react";
...
type SpringCleanupServicePageProps = {
  service: Service;
};

const includedItems = [
  "Leaves and winter debris removed",
  "Beds cleaned and redefined",
  "Dead growth cleared",
  "Bushes and hedges trimmed",
  "Edges and walkways cleaned up"
];

const relatedServiceImages: Record<string, string> = {
  "leaf-cleanup": "/photos/leaf-cleanup-working.jpg",
...
const processSteps = [
  {
    ...
    body: "Send photos or a quick note about what needs attention."
  },
  {
    eyebrow: "02",
    title: "Get a clear spring scope",
    body: "We confirm cleanup, trimming, edging, mulch, and haul-away."
  },
  {
    eyebrow: "03",
    title: "Come home to a reset yard",
    body: "The crew completes the work and leaves the property cleaned up."
  }
];
...
const faqItems = [
  {
    ...
    answer:
      "Usually no. If we can access the property and the scope is clear, we can complete the work and send updates."
  },
  {
    question: "How fast can I get on the schedule?",
    answer:
      "We respond within 24 hours. Spring fills quickly, so earlier requests usually get better date options."
  },
  {
    question: "Can you mulch after the cleanup?",
    answer:
      "Yes. Cleanup plus mulch is one of the cleanest spring combinations because the beds are reset before fresh material goes down."
  },
  {
    question: "Is debris removal included?",
    answer:
      "Off-site debris removal is available as an add-on and listed clearly in the quote before work begins."
  }
];
...
export function SpringCleanupServicePage({ service }: SpringCleanupServicePageProps) {
        ...
        <section className="relative overflow-hidden bg-brand-ink text-white">
          <div className="relative min-h-[calc(100svh-78px)] lg:min-h-[calc(100vh-82px)]">
            <Image
              ...
              alt="Finished residential landscaping by Iconic Landscaping"
              fill
              sizes="100vw"
            ...
            <div className="section-shell relative flex min-h-[calc(100svh-78px)] flex-col items-center justify-center py-16 text-center lg:min-h-[calc(100vh-82px)] lg:py-20">
              <div className="mx-auto max-w-5xl">
                ...
                <div className="mx-auto mt-9 flex w-full max-w-sm flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:items-center sm:justify-center">
                  <Button
                    href="/contact#quote"
                    ariaLabel="Get a free spring cleanup quote"
                    ...
                    trackEventParams={{ source: "spring_cleanup_hero" }}
                  >
                    Get a Free Quote
                  </Button>
                  <a
                    ...
                    data-track-params='{"source":"spring_cleanup_hero"}'
                  >
                    Call {PHONE_DISPLAY}
                  </a>
                </div>
          ...
          <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start lg:gap-16">
            ...
            <div>
              ...
              <p className="mt-5 inline-flex rounded-full bg-brand-bone px-4 py-2 text-sm font-semibold text-brand-forest">
                Mulch and planting available if needed.
              </p>
            </div>
          </div>
        </section>
              ...
              <figure className="group">
                <div className="relative aspect-[16/10] overflow-hidden rounded">
                  <Image
                    ...
                    alt="Finished landscaping after cleanup"
                    fill
                    sizes="(min-width: 1024px) 65vw, 100vw"
                    className="object-cover object-bottom transition-transform duration-700 group-hover:scale-[1.015]"
                  />
                </div>
                  <figcaption className="meta mt-3 text-brand-ink/55">Finished cleanup result</figcaption>
              </figure>
                ...
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
                      ...
                      alt="Finished landscaping detail after cleanup"
                      fill
                      sizes="(min-width: 1024px) 32vw, 50vw"
                      className="object-cover object-bottom"
                    />
                  </div>
                  <figcaption className="meta mt-3 text-brand-ink/55">Recent result</figcaption>
                </figure>
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
          ...
          <div className="grid gap-8 rounded bg-brand-bone px-5 py-7 md:px-8 md:py-9 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            <div>
              ...
              <a
                ...
                data-track-params='{"source":"spring_cleanup_process"}'
              >
          ...
          <div className="section-shell">
            <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-16">
              <div>
                ...
                <h2 className="mt-4 h-section max-w-xl">Spring cleanup across Chester and Montgomery Counties.</h2>
                <p className="lede mt-5 text-brand-ink/70">
                  Based in Pottstown and active in nearby neighborhoods where spring curb appeal matters.
                </p>
              </div>
              <div className="grid border-y hairline md:grid-cols-2">
                {featuredAreas.map((area) => (
                  <Link
                    key={area.slug}
                    href={`/areas/${area.slug}/spring-cleanup`}
        ...
        <section className="relative overflow-hidden bg-brand-forest text-brand-cream">
          ...
          <div className="section-shell relative band-feature text-center">
            ...
            <h2 className="mx-auto mt-5 max-w-4xl font-[var(--font-fraunces)] text-[clamp(2.6rem,7vw,5.3rem)] font-medium leading-[0.95] tracking-[-0.01em]">
              Spring cleanup dates fill quickly.
            </h2>
            ...
            <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
              <Button
                href="/contact#quote"
                ariaLabel="Request a spring cleanup quote"
                variant="secondary"
                className="px-9 py-4 text-base"
                trackEventName="cta_quote_click"
                trackEventParams={{ source: "spring_cleanup_bottom" }}
              >
                Get a Free Quote
              </Button>
              <a
                ...
                data-track-event="click_to_text"
                data-track-params='{"source":"spring_cleanup_bottom"}'
              >
                Text {PHONE_DISPLAY}
              </a>
            </div>
