...
import { MulchOptionsSelector } from "@/components/MulchOptionsSelector";
...
type MulchingServicePageProps = {
  service: Service;
};

const includedItems = [
  "Mulch quantity planned before install",
  "Beds cleaned before fresh mulch",
  "Clean edges around mulched areas",
  "Fresh mulch installed to a proper depth",
  "Walkways and surrounding areas tidied"
];

const relatedServiceImages: Record<string, string> = {
  "bed-cleanup": "/photos/home/bed-cleanup.jpg",
  edging: "/photos/services/edging/during.jpg",
  planting: "/photos/services/planting/after.jpg"
};
...
const processSteps = [
  {
    eyebrow: "01",
    title: "Send the bed details",
    body: "Send photos or a quick note about the beds you want refreshed."
  },
  {
    eyebrow: "02",
    title: "Confirm material and scope",
    body: "We confirm cleanup, edging, mulch type, quantity, and delivery."
  },
  {
    eyebrow: "03",
    title: "Come home to finished beds",
    body: "The crew installs the mulch evenly and leaves the property tidy."
  }
];
...
const faqItems = [
  {
    ...
    answer:
      "Yes. We can handle ordering and delivery coordination so you do not need to source anything yourself."
  },
  {
    question: "How much mulch do I need?",
    answer:
      "We calculate mulch quantity during the quote process based on bed size and existing depth."
  },
  {
    question: "Should I clean beds before mulching?",
    answer:
      "Yes. We recommend cleaning beds first, then mulching in the same visit for a cleaner and longer-lasting result."
  },
  {
    question: "Can I choose the mulch color?",
    answer:
      "Yes. We confirm the mulch finish before ordering, including common dyed, hardwood, bark, cedar, and compost options."
  }
];
...
export function MulchingServicePage({ service }: MulchingServicePageProps) {
  ...
  return (
    <>
      ...
      <SchemaMarkup
        type="faqPage"
        payload={{
          items: faqItems.map((faq) => ({ question: faq.question, answer: faq.answer }))
        }}
      />
      ...
      <main className="bg-brand-cream pb-[86px] lg:pb-0">
        <section className="relative overflow-hidden bg-brand-ink text-white">
          <div className="relative min-h-[calc(100svh-78px)] lg:min-h-[calc(100vh-82px)]">
            <Image
              ...
              alt="Fresh mulch installed by Iconic Landscaping"
              fill
              sizes="100vw"
            ...
            <div className="section-shell relative flex min-h-[calc(100svh-78px)] flex-col items-center justify-center py-16 text-center lg:min-h-[calc(100vh-82px)] lg:py-20">
              <div className="mx-auto max-w-5xl">
                ...
                <div className="mx-auto mt-9 flex w-full max-w-sm flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:items-center sm:justify-center">
                  <Button
                    href="/contact#quote"
                    ariaLabel="Get a free mulching quote"
                    ...
                    trackEventParams={{ source: "mulching_hero" }}
                  >
                    Get a Free Quote
                  </Button>
                  <a
                    ...
                    data-track-params='{"source":"mulching_hero"}'
                  >
                    Call {PHONE_DISPLAY}
                  </a>
                </div>
          ...
          <div className="grid gap-9 lg:grid-cols-[0.82fr_1.18fr] lg:items-start lg:gap-16">
            ...
            <div>
              ...
              <p className="mt-5 inline-flex rounded-full bg-brand-bone px-4 py-2 text-sm font-semibold text-brand-forest">
                Bed cleanup and edging available if needed.
              </p>
            </div>
          </div>
        </section>
              ...
              <figure className="group">
                <div className="relative aspect-[16/10] overflow-hidden rounded">
                  <Image
                    ...
                    alt="Finished mulch installation"
                    fill
                    sizes="(min-width: 1024px) 65vw, 100vw"
                    className="object-cover object-bottom transition-transform duration-700 group-hover:scale-[1.015]"
                  />
                </div>
                <figcaption className="meta mt-3 text-brand-ink/55">Finished mulch result</figcaption>
              </figure>
              <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
                      src="/photos/home/mulching.jpg"
                      alt="Fresh mulch detail"
                      fill
                      sizes="(min-width: 1024px) 32vw, 50vw"
                      className="object-cover object-bottom"
                    />
                  </div>
                  <figcaption className="meta mt-3 text-brand-ink/55">Fresh mulch detail</figcaption>
                </figure>
                <figure>
                  <div className="relative aspect-[4/3] overflow-hidden rounded">
                    <Image
                      src="/photos/services/spring-cleanup/hero.jpg"
                      alt="Iconic Landscaping local crew"
                      fill
                      sizes="(min-width: 1024px) 32vw, 50vw"
                      className="rotate-180 object-cover"
                    />
                  </div>
                  <figcaption className="meta mt-3 text-brand-ink/55">Local crew</figcaption>
                </figure>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-8 rounded bg-brand-bone px-5 py-7 md:px-8 md:py-9 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-12">
            <div>
              ...
              <a
                ...
                data-track-params='{"source":"mulching_process"}'
              >
                ...
                <div className="mt-6 grid gap-px overflow-hidden rounded bg-brand-cream/18 md:grid-cols-2">
                  {service.reviews.slice(1, 3).map((review) => (
                    <figure key={`${review.author}-${review.quote}`} className="bg-brand-ink px-1 py-5 md:p-6">
                      ...
                      <figcaption className="mt-4 text-sm font-bold text-brand-tan">
                        {review.author}
                      </figcaption>
                    </figure>
                  ))}
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-8 border-y hairline">
              {faqItems.map((faq) => (
                <details
                  key={faq.question}
                  className="group border-b hairline py-4 last:border-b-0"
                >
          ...
          <div className="section-shell">
            <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-16">
              <div>
                ...
                <h2 className="mt-4 h-section max-w-xl">Mulching across Chester and Montgomery Counties.</h2>
                <p className="lede mt-5 text-brand-ink/70">
                  Based in Pottstown and active in nearby neighborhoods where fresh mulch makes beds feel finished.
                </p>
              </div>
        ...
        <section className="section-shell py-12 md:py-16">
          <div className="grid gap-9 lg:grid-cols-[0.72fr_1.28fr] lg:items-start lg:gap-16">
            <div>
              <p className="meta text-brand-forest">Mulch options</p>
              <h2 className="mt-4 font-[var(--font-fraunces)] text-[clamp(2.15rem,6vw,3.7rem)] font-medium leading-[0.98] tracking-[-0.01em] text-brand-ink">
                Mulch options we offer.
              </h2>
              <p className="mt-5 max-w-md text-sm leading-relaxed text-brand-ink/62 md:text-base">
                We confirm color, material, and quantity before ordering.
              </p>
            </div>
            <MulchOptionsSelector />
          </div>
        </section>
              ...
              {related.map((item) => (
                ...
                >
                  <span className="relative block aspect-[4/3] overflow-hidden">
                    <Image
                      src={relatedServiceImages[item.slug] ?? `/photos/services/${item.slug}/after.jpg`}
        ...
        <section className="relative overflow-hidden bg-brand-forest text-brand-cream">
          <Image
            src="/photos/home/after/after-4.jpg"
            alt="Finished mulch after service"
            fill
            sizes="100vw"
            className="object-cover"
          />
          ...
          <div className="section-shell relative band-feature text-center">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-brand-cream/72">
              Send the request now and we will respond within 24 hours with next steps.
            </p>
            <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
              <Button
                href="/contact#quote"
                ariaLabel="Request a mulching quote"
                variant="secondary"
                className="px-9 py-4 text-base"
                trackEventName="cta_quote_click"
                trackEventParams={{ source: "mulching_bottom" }}
              >
                Get a Free Quote
              </Button>
              <a
                ...
                data-track-event="click_to_text"
                data-track-params='{"source":"mulching_bottom"}'
              >
                Text {PHONE_DISPLAY}
              </a>
            </div>
            <p className="mt-7 inline-flex items-center justify-center gap-2 text-sm font-semibold text-brand-cream/72">
              ...
              Best time to book: spring and fall
            </p>
          </div>
        </section>
      </main>
