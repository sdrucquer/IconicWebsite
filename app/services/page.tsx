...
export default function ServicesPage() {
  return (
    <>
      ...
      <section className="section-shell py-14 md:py-16 lg:py-20 xl:py-24">
        <div className="texture-panel rounded-2xl border border-brand-primary/15 p-6 shadow-card md:p-9">
          ...
          <h1 className="mt-4 max-w-4xl font-display text-4xl font-extrabold leading-tight text-brand-dark md:text-6xl lg:max-w-5xl lg:text-7xl">
      ...
      <section className="section-shell py-8 md:py-12 lg:py-16">
        ...
        <div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2 lg:gap-7 xl:grid-cols-3">
      ...
      <section className="section-shell py-12 md:py-16 lg:py-20">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3 lg:gap-7">
          {serviceBundles.map((bundle) => (
            <article key={bundle.title} className="rounded-2xl border border-brand-primary/12 bg-white p-6 shadow-soft lg:p-8">
              <h3 className="font-display text-2xl font-bold text-brand-dark lg:text-3xl">{bundle.title}</h3>
              <p className="mt-2 text-sm leading-relaxed text-brand-dark/75 lg:text-base">{bundle.copy}</p>
              <ul className="mt-4 space-y-2">
                {bundle.items.map((item) => (
                  <li key={item} className="inline-flex items-center gap-2 text-sm font-medium text-brand-dark/90 lg:text-base">
      ...
      <section className="section-shell py-12 md:py-16 lg:py-20">
        <div className="rounded-2xl border border-brand-primary/12 bg-brand-dark p-6 text-white shadow-card md:p-8 lg:p-10">
      ...
      <section className="section-shell py-8 md:py-12 lg:py-14">
        <FaqTeaser />
      </section>
    </>
  );
